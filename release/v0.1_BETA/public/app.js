...
\
				<msg :type="\'error\'" :msg="\'Error starting server instance.\'" v-if="err != 0"></msg>\
\
				...
				<table>\
					...
					<tbody>\
						<tr v-for="instance in instances">\
							...
							<td>\
								<!--<i class="fa fa-terminal" aria-hidden="true" title="Show console output"></i>-->\
...
\
				<table>\
					<thead>\
						<tr>\
							<td class="w5">ID</td>\
							<td class="w40">Login</td>\
							<td class="w40">E-Mail</td>\
							<td></td>\
						</tr>\
					</thead>\
					<tbody>\
